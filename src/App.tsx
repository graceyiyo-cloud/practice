...
export default function App(){
 ...
 const check=(e:FormEvent)=>{e.preventDefault();if(!cur||!answer.trim())return;const ok=answer.trim().toLowerCase()===cur.en.toLowerCase();if(ok){setResult("correct");setScore(s=>s+1)}else{setResult("wrong");setAttempts(a=>a+1);setAnswer("")}};
